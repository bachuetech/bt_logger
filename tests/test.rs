...
mod logger_tests {
    ...
    fn test_info_error(){
        ...
        build_logger("BACHUETECH", "LOGGER.TEST", LogLevel::VERBOSE, LogTarget::STD_ERROR);        
        log_fatal!("test_level","FATAL from {}","BT Logger");
        log_error!("test_level","ERROR from {}","BT Logger");
        log_warning!("test_level","WARN from {}","BT Logger");
        log_info!("test_level","INFO from {}","BT Logger");
    ...
    fn test_info_out(){
        ...
        build_logger("BACHUETECH", "LOGGER.TEST", LogLevel::VERBOSE, LogTarget::STD_OUT);        
        log_fatal!("test_level","FATAL from {}","BT Logger");
        log_error!("test_level","ERROR from {}","BT Logger");
        log_warning!("test_level","WARN from {}","BT Logger");
        log_info!("test_level","INFO from {}","BT Logger");
    ...
    fn test_get_error_msg_werr(){
        ...
        build_logger("BACHUETECH", "LOGGER.TEST", LogLevel::ERROR, LogTarget::STD_ERROR);        
